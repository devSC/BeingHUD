...
@interface NHProgressHUD : NSObject
 ...
 *  @param completion after the block be executed the completion will be invoke
 */
+ (void)hideHUDAfterExecutedBlock:(dispatch_block_t)block onQueue:(dispatch_queue_t)queue completionBlock:(dispatch_block_t)completion;@end
